  ...
  useEffect(() => {
    const fetchContent = async () => {
      ...
      try {
        ...
        const [storiesData, spotlightData, reelsData] = await Promise.all([
          fetchData(`${API_URL}/api/stories`).catch(e => { console.error(e); return []; }),
          fetchData(`${API_URL}/api/spotlight`).catch(e => { console.error(e); return []; }),
          fetchData(`${API_URL}/api/reels`).catch(e => { console.error(e); return []; }),
        ]);
